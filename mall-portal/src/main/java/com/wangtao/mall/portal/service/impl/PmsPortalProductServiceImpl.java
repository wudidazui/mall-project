...
import com.wangtao.mall.mapper.*;
...
import com.wangtao.mall.portal.service.PmsPortalProductService;
...
public class PmsPortalProductServiceImpl implements PmsPortalProductService {
    ...
    public List<PmsProductCategoryNode> categoryTreeList() {
        ...
        List<PmsProductCategoryNode> result = allList.stream().filter(item -> item.getParentId().equals(0L))
    ...
    private PmsProductCategoryNode covert(PmsProductCategory item, List<PmsProductCategory> allList) {
        ...
        List<PmsProductCategoryNode> children = allList.stream().filter(subItem -> subItem.getParentId().equals(item.getId()))
