...
import com.wangtao.mall.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @ResponseBody
    public CommonResult login(@Validate @RequestBody UmsAdminLoginParam umsAdminLoginParam){
    ...
    public CommonResult updatePassword(@Validated @RequestBody UpdateAdminPasswordParam updatePasswordParam){
        ...
        if (status > 0) {
           ...
           return CommonResult.failed("找到不到用户");
        }else if (status == -3){
